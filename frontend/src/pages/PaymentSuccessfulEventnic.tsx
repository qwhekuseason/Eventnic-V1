...
<p className="font-body-lg text-body-lg text-secondary max-w-[512px] mx-auto">Your payment was processed successfully. Get ready for an unforgettable experience at the Global Tech Summit 2024.</p>
</div>
...
<p className="font-headline-sm text-headline-sm text-on-surface">EP-99420-TX</p>
</div>
<div className="text-right">
<span className="font-label-sm text-label-sm text-secondary uppercase tracking-widest">Date</span>
<p className="font-body-md text-body-md text-on-surface">Oct 24, 2024</p>
</div>
</div>
<div className="flex flex-col md:flex-row gap-lg mb-lg">
<div className="w-full md:w-32 h-32 rounded-lg overflow-hidden flex-shrink-0">
<img alt="Event Image" className="w-full h-full object-cover" data-alt="A professional high-tech conference hall with a large stage, vibrant violet and blue accent lighting, and a diverse audience of professionals engaged in a keynote presentation. The image conveys a premium corporate atmosphere with clean lines, high-end production value, and a sense of innovation and global networking." src="/images/stitch-504f3f574d181f3a.png"/>
</div>
